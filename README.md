...
| `backup usage`               | Show backup-specific usage (folder naming, counter, sudo requirement) |
...
# Show backup usage details (folder naming, counter behaviour, sudo requirement)
mcli backup usage
mcli backup --usage
```
